 ...
 * @author Ziyan
 */
public class ACSetRetailPrice extends javax.swing.JFrame {

    public ACSetRetailPrice(String username, int ac_id) {
        initComponents();
        ...
        Connection con;
            ...
            void LoadTable(){
                ...
                DefaultTableModel tm = (DefaultTableModel) priceTbl.getModel();
                   ...
                   ResultSet rs =  stmt.executeQuery("SELECT * FROM retail_price_tbl;");
                   while(rs.next()){
                        int itemID = rs.getInt("item_id");
                        String itemName = rs.getString("item_name");
                        String itemPrice = rs.getString("item_price");
                        String itemQuantity = rs.getString("item_quantity");
                        tm.addRow(new Object[]{itemID,itemName,itemQuantity,itemPrice});
                    }
    ...
    private void initComponents() {
        ...
        jLabel3.setText("Add Retail Supply");
    ...
    private void addBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_addBtnActionPerformed
        ...
        try {
            ...
            String insertQuery = ("INSERT INTO `auctionappdb`.`retail_price_tbl` (`item_name`, `item_price`, `item_quantity`) VALUES ('"+name+"', '"+price+"', '"+quantity+"');");
//            stmt.execute(insertQuery);
            ...
            if(i>0){
                ...
                ResultSet rs =  s.executeQuery("SELECT * FROM retail_price_tbl;");
        ...
        //this is there to catch the error when a user tries to insert the same item again
    ...
    private void addBtn2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_addBtn2ActionPerformed
        new ACLanding(userName, acID).setVisible(true);
        this.dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ACSetRetailPrice.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
...
//            public void run() {
//                new ACSetRetailPrice().setVisible(true);
//            }
//        });
    }
